...
var config = {
   ...
   */
  // easemob-demo#easeim
  appkey: appkey || (isSandBox ? "easemob-demo#support" : "easemob#easeim"),
  /*
   * Application Host
   */
  Host: "easemob.com",
   ...
   */
  https: isCustomConfig ? https : true,
  ...
  isHttpDNS: isCustomConfig ? isHttpDNS : true,
  /*

...
var config = {
     ...
     * XMPP server
     */
    xmppURL: getUrl().apiUrl,//(window.location.protocol === "https:" ? "https:" : "http:") + "//im-api-v2.easemob.com/ws",
    ...
    apiURL: getUrl().xmppUrl,//(window.location.protocol === "https:" ? "https:" : "http:") + "//a1.easemob.com",
